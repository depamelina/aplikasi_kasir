					...
					<table id="example1" class="table table-bordered table-striped">
					  ...
					  <tr>
    					...
    					<td>
											 ...
											 href="<?= base_url()?>Kasir/CetakFakturPembelian/<?= $o->id ?>"
											 target="_blank">
...
<!--Modal-->
	...
	<script>
		...
		function save(){
			...
			$.ajax({
				url		: "<?= base_url()?>Kasir/SaveTransaksiPembelian",
				method	: "POST",
				data	: {id_supplier:id_supplier},
				success	: function(data){
					window.location = "<?= base_url()?>Kasir/pembelian";
				}
			});
		}
		...
		function tambah() {
			...
			function hapuss(){
				var id = $('[name="id"]').val();
				$.ajax({
					url		: "<?= base_url()?>Kasir/pembelian_delete",
					method	: "POST",
					data	: {id: id},
					success	: function(data){
						window.location = "<?= base_url()?>Kasir/pembelian";
