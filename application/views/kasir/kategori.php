...
<script>
		$(function () {
			...
			$(document).on('click','#btn-create',function(){
				...
				document.form.action = '<?php echo base_url();?>kasir/Create5';
			});
				...
				document.form.action = '<?php echo base_url();?>kasir/Update5';
			};
			...
			function btn_delete (id,nama){
				...
				document.form.action = '<?php echo base_url();?>kasir/Delete5';
			};
