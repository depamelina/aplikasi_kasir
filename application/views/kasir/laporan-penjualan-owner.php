  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Penjualan Per Owner</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
			...
			<div class="row">
				<div class="col-6">
				 <div class="card">
				  ...
				  <!-- /.card-header -->
					<div class="card-body">
						<form action="<?= base_url()?>Kasir/CetakLaporanPenjualanOwner" target="_blank">
						<div class="col-12">
							<div class="form-group">
								<label>Owner</label>
								<select class="form-control selectpicker" name="id_owner" data-live-search="true" >
