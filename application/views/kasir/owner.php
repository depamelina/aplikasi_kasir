				 ...
				 <div class="card">
				  ...
				  <div class="card-body">
					...
					<table id="example1" class="table table-bordered table-striped">
					  ...
					  <tbody>
					  <?php $no=1; foreach($read_owner as $o){
						 ?>
					  <tr>
						<td><?= $no++ ?></td>
						<td><?= $o->nama_owner ?></td>
						...
						<td><?= $o->no_hp ?></td>
						<td>
											 <button class="btn btn-success btn-sm" onclick="return btn_update(`<?= $o->id ?>`,`<?= $o->nama_owner ?>`,`<?= $o->alamat ?>`,`<?= $o->no_hp?>`)" >
												 <i class="fa fa-pen"></i>
												 Update
											 </button>
											 <button type="button" class="btn btn-danger btn-sm" id="btn-delete" onclick="return btn_delete(`<?= $o->id ?>`,`<?= $o->nama_owner ?>`)">
...
<script>
		$(function () {
			...
			$(document).on('click','#btn-create',function(){
				...
				document.form.action = '<?php echo base_url();?>kasir/Create2';
			});
			
			function btn_update (id,nama_owner,alamat,no_hp){
				$('#Modal').modal('show');
				...
				document.form.action = '<?php echo base_url();?>kasir/Update2';
			};
			
			function btn_delete (id,nama_owner){
				$('#Modal').modal('show');
				...
				document.form.action = '<?php echo base_url();?>kasir/Delete2';
			};
					...
					<div class="modal-body">
						...
						<span id="modal-body-update-or-create">
							<div class="form-group">
								...
								<input type="text" name="nama_owner" class="form-control" placeholder="Nama Owner">
							</div>
							<div class="form-group">
								<label>Alamat</label>
