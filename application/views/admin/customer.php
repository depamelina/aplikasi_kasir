...
<script>
		$(function () {
			...
			$(document).on('click','#btn-create',function(){
				...
				document.form.action = '<?php echo base_url();?>admin/Create6';
			});
			...
			function btn_update (id,nama,status){
				...
				document.form.action = '<?php echo base_url();?>admin/Update6';
			};
			...
			function btn_delete (id,nama){
				...
				document.form.action = '<?php echo base_url();?>admin/Delete6';
			};
