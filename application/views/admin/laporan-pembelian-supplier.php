        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Laporan Pembelian Supplier</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
			...
			<div class="row">
				<div class="col-6">
				 <div class="card">
				  ...
				  <!-- /.card-header -->
					<div class="card-body">
						<form action="<?= base_url()?>Admin/CetakLaporanPembelianSupplier" target="_blank">
						
						<div class="col-12">
							<div class="form-group">
								<label>Supplier</label>
								<select class="form-control selectpicker" name="id_supplier" data-live-search="true" >
									<?php foreach($read_supplier as $r){ ?>
