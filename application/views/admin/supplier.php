...
<script>
		$(function () {
			...
			$(document).on('click','#btn-create',function(){
				...
				document.form.action = '<?php echo base_url();?>admin/Create4';
			});
			...
			function btn_update (id,nama_supplier,alamat,no_hp){
				...
				document.form.action = '<?php echo base_url();?>admin/Update4';
			};
			...
			function btn_delete (id,nama_supplier){
				...
				document.form.action = '<?php echo base_url();?>admin/Delete4';
			};
