				 ...
				 <div class="card">
				  ...
				  <div class="card-body">
					...
					<table id="example1" class="table table-bordered table-striped">
					  ...
					  <tbody>
					  <?php $no=1; foreach($read_kategori as $o){
						 ?>
					  <tr>
						<td><?= $no++ ?></td>
						<td><?= $o->nama ?></td>
    					<td>
											 <button class="btn btn-success btn-sm" id="btn-update" onclick="return btn_update(`<?= $o->id ?>`,`<?= $o->nama ?>`)" >
												 <i class="fa fa-pen"></i>
												 Update
											 </button>
...
<script>
		$(function () {
			...
			$(document).on('click','#btn-create',function(){
				...
				document.form.action = '<?php echo base_url();?>admin/Create5';
			});
				...
				document.form.action = '<?php echo base_url();?>admin/Update5';
			};
			...
			function btn_delete (id,nama){
				...
				document.form.action = '<?php echo base_url();?>admin/Delete5';
			};
