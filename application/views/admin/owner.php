...
<script>
		$(function () {
			...
			$(document).on('click','#btn-create',function(){
				...
				document.form.action = '<?php echo base_url();?>admin/Create2';
			});
			...
			function btn_update (id,nama_owner,alamat,no_hp){
				...
				document.form.action = '<?php echo base_url();?>admin/Update2';
			};
			...
			function btn_delete (id,nama_owner){
				...
				document.form.action = '<?php echo base_url();?>admin/Delete2';
			};
